# ASIMOV.rs: Nexus Client

[![License](https://img.shields.io/badge/license-Public%20Domain-blue.svg)](https://unlicense.org)
[![Compatibility](https://img.shields.io/badge/rust-1.85%2B-blue)](https://blog.rust-lang.org/2025/02/20/Rust-1.85.0/)
[![Package](https://img.shields.io/crates/v/asimov-nexus)](https://crates.io/crates/asimov-nexus)
[![Documentation](https://img.shields.io/docsrs/asimov-nexus?label=docs.rs)](https://docs.rs/asimov-nexus)
...
```toml
[dependencies]
asimov-nexus = { version = "25", default-features = false, features = ["tracing"] }
```
...
[docs.rs/asimov-nexus](https://docs.rs/asimov-nexus)
