...
[![Package](https://img.shields.io/crates/v/asimov-huggingface)](https://crates.io/crates/asimov-huggingface)
[![Documentation](https://img.shields.io/docsrs/asimov-huggingface?label=docs.rs)](https://docs.rs/asimov-huggingface)
...
```toml
[dependencies]
asimov-huggingface = { version = "25", default-features = false, features = ["tracing"] }
```
...
```rust
use asimov_huggingface::*;
```

## 📚 Reference

[docs.rs/asimov-huggingface](https://docs.rs/asimov-huggingface)
