...
[![Package](https://img.shields.io/crates/v/asimov-agent)](https://crates.io/crates/asimov-agent)
[![Documentation](https://img.shields.io/docsrs/asimov-agent?label=docs.rs)](https://docs.rs/asimov-agent)
...
```toml
[dependencies]
asimov-agent = { version = "25", default-features = false, features = ["tracing"] }
```
...
[docs.rs/asimov-agent](https://docs.rs/asimov-agent)
