...
[![Package](https://img.shields.io/crates/v/asimov-protocol)](https://crates.io/crates/asimov-protocol)
[![Documentation](https://img.shields.io/docsrs/asimov-protocol?label=docs.rs)](https://docs.rs/asimov-protocol)
...
```toml
[dependencies]
asimov-protocol = { version = "25", default-features = false, features = ["tracing"] }
```
...
[docs.rs/asimov-protocol](https://docs.rs/asimov-protocol)
