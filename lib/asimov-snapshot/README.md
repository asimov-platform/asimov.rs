...
[![Package](https://img.shields.io/crates/v/asimov-snapshot)](https://crates.io/crates/asimov-snapshot)
[![Documentation](https://img.shields.io/docsrs/asimov-snapshot?label=docs.rs)](https://docs.rs/asimov-snapshot)
...
```toml
[dependencies]
asimov-snapshot = { version = "25", default-features = false, features = ["tracing"] }
```
...
[docs.rs/asimov-snapshot](https://docs.rs/asimov-snapshot)
