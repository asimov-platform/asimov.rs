# ASIMOV.rs: Identifier Types

[![License](https://img.shields.io/badge/license-Public%20Domain-blue.svg)](https://unlicense.org)
[![Compatibility](https://img.shields.io/badge/rust-1.85%2B-blue)](https://blog.rust-lang.org/2025/02/20/Rust-1.85.0/)
[![Package](https://img.shields.io/crates/v/asimov-id)](https://crates.io/crates/asimov-id)
[![Documentation](https://img.shields.io/docsrs/asimov-id?label=docs.rs)](https://docs.rs/asimov-id)
...
```toml
[dependencies]
asimov-id = { version = "25", default-features = false, features = ["tracing"] }
```
...
[docs.rs/asimov-id](https://docs.rs/asimov-id)
