# ASIMOV.rs: Configuration Management

[![License](https://img.shields.io/badge/license-Public%20Domain-blue.svg)](https://unlicense.org)
[![Compatibility](https://img.shields.io/badge/rust-1.85%2B-blue)](https://blog.rust-lang.org/2025/02/20/Rust-1.85.0/)
[![Package](https://img.shields.io/crates/v/asimov-config)](https://crates.io/crates/asimov-config)
[![Documentation](https://img.shields.io/docsrs/asimov-config?label=docs.rs)](https://docs.rs/asimov-config)
...
```toml
[dependencies]
asimov-config = { version = "25", default-features = false, features = ["tracing"] }
```
...
[docs.rs/asimov-config](https://docs.rs/asimov-config)
