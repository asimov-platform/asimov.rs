...
```toml
[dependencies]
asimov-graph = { version = "25", default-features = false, features = ["tracing"] }
```
...
[docs.rs/asimov-graph](https://docs.rs/asimov-graph)
