...
[![Package](https://img.shields.io/crates/v/asimov-ontology)](https://crates.io/crates/asimov-ontology)
[![Documentation](https://img.shields.io/docsrs/asimov-ontology?label=docs.rs)](https://docs.rs/asimov-ontology)
...
```toml
[dependencies]
asimov-ontology = { version = "25", default-features = false, features = ["tracing"] }
```
...
[docs.rs/asimov-ontology](https://docs.rs/asimov-ontology)
