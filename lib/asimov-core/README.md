...
[![Package](https://img.shields.io/crates/v/asimov-core)](https://crates.io/crates/asimov-core)
[![Documentation](https://img.shields.io/docsrs/asimov-core?label=docs.rs)](https://docs.rs/asimov-core)
...
```toml
[dependencies]
asimov-core = { version = "25", default-features = false, features = ["tracing"] }
```
...
[docs.rs/asimov-core](https://docs.rs/asimov-core)
