...
[![Package](https://img.shields.io/crates/v/asimov-dataset)](https://crates.io/crates/asimov-dataset)
[![Documentation](https://img.shields.io/docsrs/asimov-dataset?label=docs.rs)](https://docs.rs/asimov-dataset)
...
```toml
[dependencies]
asimov-dataset = { version = "25", default-features = false, features = ["tracing"] }
```
...
[docs.rs/asimov-dataset](https://docs.rs/asimov-dataset)
