...
[![Package](https://img.shields.io/crates/v/asimov-credit)](https://crates.io/crates/asimov-credit)
[![Documentation](https://img.shields.io/docsrs/asimov-credit?label=docs.rs)](https://docs.rs/asimov-credit)
...
```toml
[dependencies]
asimov-credit = { version = "25", default-features = false, features = ["tracing"] }
```
...
[docs.rs/asimov-credit](https://docs.rs/asimov-credit)
