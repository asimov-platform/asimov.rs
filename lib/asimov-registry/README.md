...
[![Package](https://img.shields.io/crates/v/asimov-registry)](https://crates.io/crates/asimov-registry)
[![Documentation](https://img.shields.io/docsrs/asimov-registry?label=docs.rs)](https://docs.rs/asimov-registry)
...
```toml
[dependencies]
asimov-registry = { version = "25", default-features = false, features = ["tracing"] }
```
...
[docs.rs/asimov-registry](https://docs.rs/asimov-registry)
