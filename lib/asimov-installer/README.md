...
```toml
[dependencies]
asimov-installer = { version = "25", default-features = false, features = ["tracing"] }
```
...
```rust
use asimov_installer::*;
```

## 📚 Reference

[docs.rs/asimov-installer](https://docs.rs/asimov-installer)
