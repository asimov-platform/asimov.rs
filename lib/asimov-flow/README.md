...
[![Package](https://img.shields.io/crates/v/asimov-flow)](https://crates.io/crates/asimov-flow)
[![Documentation](https://img.shields.io/docsrs/asimov-flow?label=docs.rs)](https://docs.rs/asimov-flow)
...
```toml
[dependencies]
asimov-flow = { version = "25", default-features = false, features = ["tracing"] }
```
...
[docs.rs/asimov-flow](https://docs.rs/asimov-flow)
