...
[![Package](https://img.shields.io/crates/v/asimov-repository)](https://crates.io/crates/asimov-repository)
[![Documentation](https://img.shields.io/docsrs/asimov-repository?label=docs.rs)](https://docs.rs/asimov-repository)
...
```toml
[dependencies]
asimov-repository = { version = "25", default-features = false, features = ["tracing"] }
```
...
```rust
use asimov_repository::*;
```

## 📚 Reference

[docs.rs/asimov-repository](https://docs.rs/asimov-repository)
